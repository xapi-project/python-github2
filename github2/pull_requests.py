...
class PullRequest(BaseData):
    ...
    issue_created_at = Attribute("The date the issue for this pull request was opened.")
    issue_updated_at = Attribute("The date the issue for this pull request was last updated.")
